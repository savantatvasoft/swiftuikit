...
//            header.topAnchor.constraint(equalTo: headerView.topAnchor, constant: 45),
...
//        let color: UIColor = active ? .black : .systemGray
...
class BaseQuizViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        setupBackButton()
        setupHierarchy()
        setupConstraints() // This now handles both modes
        handleColorWhileTimerStart(false)
    }
