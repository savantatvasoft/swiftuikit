...
//        let homeVC = storyboard.instantiateViewController(withIdentifier: "FeedVC") as! FeedVC
//
//        let nav = UINavigationController(rootViewController: homeVC)
//
//        window.rootViewController = nav
...
//        let window = UIWindow(windowScene: windowScene)
//        let storyboard = UIStoryboard(name: "Main", bundle: nil)
//        let newsVC = storyboard.instantiateViewController(withIdentifier: "PollViewControllerID") as! PollViewController
//        let nav = UINavigationController(rootViewController: newsVC)
