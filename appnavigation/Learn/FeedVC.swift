...
class FeedVC: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        // Now the frame height is accurate based on Auto Layout
        print("contentView.frame.height : \(contentView.frame.height)")

        // Enable scroll only if we hit the max height limit
        scrollView.isScrollEnabled = contentView.frame.height >= 60
    }
